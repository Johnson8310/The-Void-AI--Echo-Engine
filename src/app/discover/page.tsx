      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
       ...
       <Card className="mt-4 border-dashed">
        <CardHeader>
          ...
          <CardDescription>
            This is a preview of the Discover feed.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <p>Soon, you'll be able to make your own projects public and see them featured here. Stay tuned for updates on community features!</p>
        </CardContent>
      </Card>
    </div>
  );
